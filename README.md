...
- **0 선(점선)이 곧 탈출의 경계**입니다. E 가 0 아래면 아무리 멀리 가도 반드시 돌아오고,
  0 위면 영영 떠납니다. 11.6 km/s 로 쏴 보면 E 선이 0 바로 위에 놓입니다.
...
> **이어지는 발문** — "역학적 에너지 선을 0 위로 올리려면 초기 속도를 얼마로 해야 할까?"
